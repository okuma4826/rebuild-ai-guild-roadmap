...
第1章から使う **学習管理用テンプレート** です。目標・時間割・日報を1冊にまとめられます。
...
6. 左下に `01_習慣設計` 〜 `04_行動変容ワーク` の **4つのシートタブ** があることを確認する
...
| 08 | 日報のはじめ | [教材](教材/第01章-明確な目標と習慣/08-日報のはじめ.md) | — |
...
| 12 | スプシで時間と別案を整える | [教材](教材/第02章-学びの土台/12-スプシで時間と別案を整える.md) | — |
