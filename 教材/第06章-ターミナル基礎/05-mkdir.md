...
第3章のGitでは、プロジェクト用のフォルダを作ってそこで作業します。
...
第3章のGit練習でもフォルダを使います。`terminal-practice` のほかに、**仕事用に作りたい練習フォルダ名**を1つ考えてみてください。

---

## 進む

[前のテーマ](04-Tab補完.md) ｜ [この章の目次](README.md) ｜ [次の章：第07章-GitとGitHub](../第07章-GitとGitHub/README.md) →
