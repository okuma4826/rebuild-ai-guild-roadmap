...
> **Rebuild練習用がない場合**：第3章または第3章でフォルダを作ってから戻ってきてください。または次の教材 05-mkdir で作ります。
...
- 「Rebuild練習用がない」→ 第3章のフォルダ整理を見直すか、05-mkdir を先にやる
...
[前のテーマ](02-pwdとls.md) ｜ [この章の目次](README.md) ｜ [次：Tab補完](04-Tab補完.md) →
