...
ここが第3章の山場です。これまでバラバラだった文章が、1枚のページとして立ち上がります。コードを自分で書く必要はありません。あなたの役割は、よい材料を渡し、出てきたものを確かめることです。完璧でなくてかまいません。まず「形になった」が大事です。
...
第3章05の `lp-outline.md` を、`lp-site` フォルダの中にコピーします。Cursorの左の一覧にこのファイルが見えていればOKです。

### ステップ2：AIに実装を頼む（10分）

Cursorのチャットを開き（第3章で使ったAgent/Chat）、次のように頼みます。
...
| 画面が崩れた | 次の第3章10で直し方を学びます。慌てなくて大丈夫 |
...
[前のテーマ](08-Cursorで開いて開発サーバーを起動する.md) ｜ [この章の目次](README.md) ｜ [次：エラーや表示崩れをAIに直してもらう](10-エラーや表示崩れをAIに直してもらう.md) →
