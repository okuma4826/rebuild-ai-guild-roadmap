...
答え合わせはこちら：  
[答えを見る](../../答え/第12章-LP公開/06-Node・mise・Next.jsをざっくり知る-答え.md)
...
**躓いたら戻る先**：[第6章 ターミナルの基本](../第06章-ターミナル基礎/01-ターミナルを開く.md)

Discordで次のように聞いてください。

```text
【今やっている教材】第3章06 Node・mise・Next.js
...
[前のテーマ](05-FAQと問い合わせ導線を決めてLP構成案にする.md) ｜ [この章の目次](README.md) ｜ [次：miseでNodeを入れてNext.jsプロジェクトを作る](07-miseでNodeを入れてNext.jsプロジェクトを作る.md) →
