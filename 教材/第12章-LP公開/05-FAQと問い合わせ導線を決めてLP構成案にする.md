...
`lp-site用メモ` フォルダに `lp-outline.md` を新規作成し、まずFAQから埋めます。このファイルは第3章09で `~/Documents/Rebuild練習用/lp-site` にコピーして使います。
...
[前のテーマ](04-サービス説明・選ばれる理由・料金を書く.md) ｜ [この章の目次](README.md) ｜ [次：Node・mise・Next.jsをざっくり知る](06-Node・mise・Next.jsをざっくり知る.md) →
