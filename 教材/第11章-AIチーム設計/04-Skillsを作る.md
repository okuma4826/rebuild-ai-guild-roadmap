...
Skillがあると、「メニュー文案を短く」「FAQを1問追加」など、**型どおりの依頼**がしやすくなります。第3章のLP改善でも使えます。
...
1. 第3章の `service-intro.md` など、長めの文案を開きます。
2. チャットで次を送ります。
...
[第10章 関連ファイルを見ながら相談](../第10章-Cursor-AI/04-関連ファイルを見ながら相談する.md)
...
[前のテーマ](03-Rulesを作る.md) ｜ [この章の目次](README.md) ｜ [次：小さな業務でAIチームを試す](05-小さな業務でAIチームを試す.md) →
