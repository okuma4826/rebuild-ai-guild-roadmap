...
AGENTS.mdはAIチームの **看板** です。第3章のLP制作でも、このファイルを読んだAIに実装を頼むと、トーンがそろいやすくなります。
...
第3章のLPを作るとき、どの方針をいちばん守りたいでしょうか。

---

## 進む

[前のテーマ](01-AIチームとは何か.md) ｜ [この章の目次](README.md) ｜ [次：Rulesを作る](03-Rulesを作る.md) →
