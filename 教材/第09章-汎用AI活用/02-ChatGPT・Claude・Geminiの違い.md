...
- 「Cursorとの違いは？」→ Cursorはエディタ内のAI。第3章で扱う
...
3. 第3章でのおすすめの進め方として、いちばん近いのはどれですか？
   - A. 3つ全部を毎日使い分ける
   - B. まず1つに慣れ、必要なら他も試す
   - C. どれも使わず検索だけ
   - D. AIに全部任せる
...
答え合わせはこちら：  
[答えを見る](../../答え/第09章-汎用AI活用/02-ChatGPT・Claude・Geminiの違い-答え.md)
...
```text
【今やっている教材】第3章 02-chatgpt-claude-gemini
...
[前のテーマ](01-生成AIとは何か.md) ｜ [この章の目次](README.md) ｜ [次：プロンプトの基本](03-プロンプトの基本.md) →
