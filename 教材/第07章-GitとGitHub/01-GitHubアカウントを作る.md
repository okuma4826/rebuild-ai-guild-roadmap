...
第3章では、Macの中のファイル変更を **Git** で記録し、**GitHub** にバックアップします。
...
- **アカウント** … あなた専用の入り口（第9章の「鍵」の考え方と同じ）
...
3. パスワードを設定する（第9章のルール：推測されにくく、他と使い回さない）。
...
- GitHubから「パスワードを教えて」とメールが来ても、第9章と同様 **教えません**。
- 2段階認証は後から設定できます（第9章 02-two-factor-auth を参照）。
...
- [第8章：ITリテラシー](../第08章-ITリテラシー/)（アカウント・パスワード）
- [第6章：ターミナル基礎](../第06章-ターミナル基礎/)

```text
【今やっている教材】第3章 01-github-account
...
[この章の目次](README.md) ｜ [次：Gitとは何か](02-Gitとは何か.md) →
