...
- 「全部公開される？」→ リポジトリを非公開にできる。個人情報は入れないのが原則（第9章）
...
3. GitHubアカウントを作った主な理由として、第3章でいちばん近いのはどれですか？
...
答え合わせはこちら：  
[答えを見る](../../答え/第07章-GitとGitHub/02-Gitとは何か-答え.md)
...
- [第3章：ファイル整理](../第03章-Macとファイル/)
- [01-github-account](./01-GitHubアカウントを作る.md)

```text
【今やっている教材】第3章 02-git-concept
...
[前のテーマ](01-GitHubアカウントを作る.md) ｜ [この章の目次](README.md) ｜ [次：git-status-add-commit](03-git-status-add-commit.md) →
