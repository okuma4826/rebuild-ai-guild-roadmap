...
[01 Cursorを月額で始める](./01-Cursorを月額で始める-最初の課金は月額で.md) で、月額の判断と公式確認を終えたあと、いよいよCursorのチャットを使います。
...
用意するもの：Mac、Cursor、仕事フォルダ（[第3章](../第03章-Macとファイル/)で作ったフォルダがあればそれを使う）

### ステップ1：Cursorを開く（3分）

1. Macの **Launchpad** または **アプリケーション** から、上の画像と同じ **Cursor** アイコンを探して起動します。
...
**躓いたら戻る先**：[第9章 06 業務の困りごとをAIに相談する](../第09章-汎用AI活用/06-業務の困りごとをAIに相談する.md) ｜ [第9章 03 プロンプトの基本](../第09章-汎用AI活用/03-プロンプトの基本.md) ｜ [第10章01 Cursor月額](./01-Cursorを月額で始める-最初の課金は月額で.md)  
[第5章 フォルダを開く](../第05章-エディタ基礎/01-フォルダを開く.md)
