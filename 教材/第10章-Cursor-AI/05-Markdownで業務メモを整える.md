...
第3章のAIチーム設計や、第3章のLP制作では、メモがそのまま「材料」になります。MarkdownはGitHubでも読みやすく、CursorのAIも扱いやすい形式です。
...
**躓いたら戻る先**：[第5章 Markdownの基本](../第05章-エディタ基礎/04-Markdownを書く.md)  
[04 関連ファイルを見ながら相談する](./04-関連ファイルを見ながら相談する.md)
...
[前のテーマ](04-関連ファイルを見ながら相談する.md) ｜ [この章の目次](README.md) ｜ [次：LP構成案とサービス説明文を作る](06-LP構成案とサービス説明文を作る.md) →
